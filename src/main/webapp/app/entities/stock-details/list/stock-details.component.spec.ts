...
import { sampleWithRequiredData } from '../stock-details.test-samples';
...
describe('StockDetails Management Component', () => {
  let comp: StockDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StockDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.stockDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to stockDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStockDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStockDetailsIdentifier).toHaveBeenCalledWith(entity);
