...
To build the final jar and optimize the BreakoutStocks application for production, run:
...
Then navigate to [http://localhost:8676](http://localhost:8676) in your browser.
